...
#ifdef DEBUG
					NSLog(@"numInsertedSections: %d", numInsertedSections);
					NSLog(@"numDeletedSections: %d", numDeletedSections);
					
					NSLog(@"numInsertedObjects: %d", numInsertedObjects);
					NSLog(@"numDeletedObjects: %d", numDeletedObjects);
#endif
