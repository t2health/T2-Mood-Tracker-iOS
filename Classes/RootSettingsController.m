...
#import "RootSettingsController.h"
...
@implementation RootSettingsController
...
- (SafeFetchedResultsController *)fetchedResultsController {
    ...
    NSString *settingsString = @"Support";
	NSPredicate *visiblePredicate = [NSPredicate predicateWithFormat:@"(section == %@) && (visible == YES)", settingsString];
