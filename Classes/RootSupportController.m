...
@implementation RootSupportController
		...
		case 0: //Results
			switch (row) {
				...
				case 2: //Feedback
					...
					break;					
				case 3: //Rate App
                    url = [NSURL URLWithString:@"http:/itunes.com/apps/t2moodtracker"];
...
- (SafeFetchedResultsController *)fetchedResultsController {
    ...
    NSString *supportString = @"Support";
	NSPredicate *visiblePredicate = [NSPredicate predicateWithFormat:@"(section == %@) && (visible == YES)", supportString];
